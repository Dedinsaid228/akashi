...
int ConfigManager::serverPort() { return m_settings->value("Options/port", 27016).toInt(); }
...
int ConfigManager::webaoPort() { return m_settings->value("Options/webao_port", 27017).toInt(); }
...
bool ConfigManager::advertiseServer() { return m_settings->value("Advertiser/advertise", "true").toBool(); }

bool ConfigManager::advertiserDebug() { return m_settings->value("Advertiser/debug", "true").toBool(); }

QUrl ConfigManager::advertiserIP() { return m_settings->value("Advertiser/ms_ip", "").toUrl(); }

QString ConfigManager::advertiserHostname() { return m_settings->value("Advertiser/hostname", "").toString(); }

bool ConfigManager::advertiserCloudflareMode() { return m_settings->value("Advertiser/cloudflare_enabled", "false").toBool(); }
