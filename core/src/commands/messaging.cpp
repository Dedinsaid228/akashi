...
void AOClient::cmdUnGimp(int argc, QStringList argv)
{
    ...
    emit logCMD((m_current_char + " " + m_showname), m_ipid, m_ooc_name, "UNGIMP", "Ungimped UID: " + QString::number(l_target->m_id), server->getAreaName(m_current_area), QString::number(m_id), m_hwid, server->getHubName(m_hub));
}
...
void AOClient::cmdUnDisemvowel(int argc, QStringList argv)
{
    ...
    emit logCMD((m_current_char + " " + m_showname), m_ipid, m_ooc_name, "UNDISEMVOWEL", "Undisemvoweled UID: " + QString::number(l_target->m_id), server->getAreaName(m_current_area), QString::number(m_id), m_hwid, server->getHubName(m_hub));
}
...
void AOClient::cmdUnShake(int argc, QStringList argv)
{
    ...
    emit logCMD((m_current_char + " " + m_showname), m_ipid, m_ooc_name, "UNSHAKE", "Unshaked UID: " + QString::number(l_target->m_id), server->getAreaName(m_current_area), QString::number(m_id), m_hwid, server->getHubName(m_hub));
}
