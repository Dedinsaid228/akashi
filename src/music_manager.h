...
class MusicManager : public QObject
{
  ...
  public:
     ...
     */
    MusicManager(QStringList f_cdns, QStringList f_root_list, QStringList f_root_ordered, QObject *parent = nullptr);
     ...
     */
    bool addCustomSong(QString f_song_name, int f_area_id, bool f_server_starting = false);
    ...
    /**
     * @brief Sets the custom music list in area when the server starts.
     */
    void setCustomMusicList(QStringList f_music_list, int f_area);

    /**
     * @brief Return the custom music list in area.
     */
  ...
  signals:
     ...
     */
    void sendFMPacket(std::shared_ptr<AOPacket> f_packet, int f_user_id);
     ...
     */
    void sendAreaFMPacket(std::shared_ptr<AOPacket> f_packet, int f_area_index);

  private:
    /**
     * @brief Contains all custom lists of all areas in the server.
     */
    QHash<int, QStringList> *m_custom_lists;

    /**
     * @brief Server musiclist shared among all areas.
     */
    QStringList m_root_list;
