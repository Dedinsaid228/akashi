...
CommandExtension::CommandExtension(QString f_command_name) { setCommandName(f_command_name); }

CommandExtension::~CommandExtension() {}

QString CommandExtension::getCommandName() const { return m_command_name; }
...
bool CommandExtension::checkCommandNameAndAlias(QString f_alias) const { return m_merged_aliases.contains(f_alias, Qt::CaseInsensitive); }

QStringList CommandExtension::getAliases() const { return m_aliases; }
...
QVector<ACLRole::Permission> CommandExtension::getPermissions() const { return getPermissions(QVector<ACLRole::Permission>{}); }

void CommandExtension::setPermissions(QVector<ACLRole::Permission> f_permissions) { m_permissions = f_permissions; }
...
void CommandExtension::setPermissionsByCaption(QStringList f_captions)
{
    ...
    for (const QString &i_caption : std::as_const(f_captions)) {
...
void CommandExtension::updateMergedAliases() { m_merged_aliases = QStringList{m_command_name} + m_aliases; }
...
QList<CommandExtension> CommandExtensionCollection::getExtensions() const { return m_extensions.values(); }

bool CommandExtensionCollection::containsExtension(QString f_command_name) const { return m_extensions.contains(f_command_name); }

CommandExtension CommandExtensionCollection::getExtension(QString f_command_name) const { return m_extensions.value(f_command_name); }
