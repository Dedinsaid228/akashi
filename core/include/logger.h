...
public slots:
     ...
     */
    void logIC(const QString& f_charName_r, const QString& f_ipid_r, const QString& f_hwid_r,
     ...
     */
    void logOOC(const QString& f_charName_r, const QString& f_ipid_r, const QString& f_hwid_r,
                const QString& f_message_r, const QString& f_showname_r, const QString& f_oocname_r, const QString& f_uid_r);
     ...
     */
    void logModcall(const QString& f_charName_r, const QString& f_ipid_r, const QString& f_hwid_r,
     ...
     */
    void logCmd(const QString& f_charName_r, const QString& f_ipid_r, const QString& f_hwid_r, const QString& f_command_r,
                const QStringList& f_cmdArgs_r, const QString& f_showname_r, const QString& f_oocname_r, const QString& f_uid_r);

    void logCmdAdvanced(const QString& f_charName_r,
     ...
     */
    void logLogin(const QString& f_charName_r, const QString& f_ipid_r, const QString& f_hwid_r, bool success,
                  const QString& f_modname_r, const QString& f_showname_r, const QString& f_oocname_r, const QString& f_uid_r);

    void LogDisconnecting(const QString& f_charName_r, const QString& f_ipid_r, const QString& f_hwid_r,
                          const QString& f_showname_r, const QString& f_oocname_r, const QString& f_uid_r);

    void LogConnect(const QString& f_ipid_r);

    void LogMusic(const QString& f_charName_r, const QString& f_ipid_r, const QString& f_hwid_r,
...
private:
    ...
    void addEntry(const QString& f_charName_r, const QString& f_ipid_r,
                  ...
                  const QString& f_hwid_r,     const QString& f_showname_r,
                  const QString& f_oocname_r,  const QString &f_uid_r);
