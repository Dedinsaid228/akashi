...
void NetworkSocket::close(QWebSocketProtocol::CloseCode f_code) { m_client_socket->close(f_code); }
...
void NetworkSocket::write(std::shared_ptr<AOPacket> f_packet) { m_client_socket->sendTextMessage(f_packet->toString()); }
