...
void AOClient::cmdHelp(int argc, QStringList argv)
{
    ...
    if (argv[0] == "other")
        ...
        sendServerMessage("[brackets] mean [required arguments], (brackets) mean (optional arguments). Actually, commands don't need these brackets. "
                          ...
                          "/toogleautomod - enable/disable Automod in the area. [CM]\n"
                          ...
                          "/clearmessage - clear the areas message and disables automatic sending. [CM]\n"
                          "/areamessage (message) - return the area message in OOC. If text is entered, it updates the current area message. [CM]\n"
        ...
        sendServerMessage("[brackets] mean [required arguments], (brackets) mean (optional arguments). Actually, commands don't need these brackets. "
                          ...
                          "/shake [uid] - shuffles the order of words in the client's IC messages. [MUTE]\n"
