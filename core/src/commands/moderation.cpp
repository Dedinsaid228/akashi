...
void AOClient::cmdHelp(int argc, QStringList argv)
{
    ...
    if (argv[0] == "other")
        ...
        sendServerMessage("[brackets] mean [required arguments], (brackets) mean (optional arguments). Actually, commands don't need these brackets. "
                          ...
                          "/areapassword (new password) - when given arguments, set the password that the client needs to set to enter the area. If no arguments are given, get the current password in area.\n"
